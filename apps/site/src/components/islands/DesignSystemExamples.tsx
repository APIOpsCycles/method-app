...
export function ContextDesignSystemExample() {
  ...
  const items = [{ id: "stakeholder" as const, label: "View as", value: "API Product Owner" }, { id: "goal" as const, label: "Goal", value: "Create or improve an API" }, { id: "cycle" as const, label: "Cycle", value: "API Productization Cycle", href: "#context-patterns" }, { id: "here" as const, label: "Here", value: "API Audit" }];
