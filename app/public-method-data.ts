...
export function allPublicPages() {
  return supportedLocales.flatMap((locale) => {
    ...
    const data = getCatalog(locale);
    return [
      { locale, path: `${prefix}/`, title: "APIOps Cycles Knowledge Catalog" },
      { locale, path: `${prefix}/partners`, title: "APIOps Cycles Partners" },
      { locale, path: `${prefix}/licensing`, title: "APIOps Cycles Licensing" },
