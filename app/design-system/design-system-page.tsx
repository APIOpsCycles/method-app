...
const tokens = [
  ...
  ["--apiops-accent-community", "var(--color-line-design)", "SVG accent for community and ecosystem"],
    ...
    <header className="app-header ds-header">
      <div className="topbar">
        <a className="brand" href={`${prefix}/`}>
          <img className="brand__logo" src="/assets/apiops-cycles-logo.svg" alt="" />
...
function DoDontIcon({ type }: { type: "do" | "dont" }) {
  ...
  return (
    <svg
      ...
      viewBox="0 0 96 96"
    >
      <use href={`/design/icons/apiops-iconset.svg#${isDo ? "icon-quality" : "icon-risk"}`} />
    </svg>
  );
}
...
function ResourceSelectorStateDemo() {
  return (
    <div className="side-resource-grid" style={{ maxWidth: 420 }}>
      <button className="side-resource-card is-active" type="button">
        <span className="side-resource-card__meta">
          <MaterialIcon name="dashboard-outline" />
          Canvas
        </span>
        <strong>Customer Journey Canvas</strong>
        <small>Capture the real customer journey, not the solution usage itself.</small>
      </button>
      <button className="side-resource-card" type="button">
        <span className="side-resource-card__meta">
          <MaterialIcon name="edit-document-outline" />
          Guide
        </span>
        <strong>API Onboarding Best Practices</strong>
        <small>Guidance for consumer onboarding, documentation, and adoption.</small>
      </button>
      <span className="side-resource-card side-resource-card--empty">
        No direct resources
      </span>
    </div>
  );
...
function CompactSectionHeaderDemo() {
  return (
    <section className="journey-criteria" style={{ maxWidth: 420 }}>
      <div className="compact-section-head">
        <h3>Key questions</h3>
        <button type="button" aria-expanded="true">▾</button>
      </div>
...
function PillListStateDemo() {
  return (
    <div className="pill-list" aria-label="Stakeholder chip list example">
      <button type="button">API Product Owner</button>
      <button type="button">API Designer</button>
      <button type="button">Platform Architect</button>
    </div>
  );
}
...
function PartnerCardDemo() {
  return (
    <a className="ds-partner-card" href="#governance">
      <img src="/partners/osaango-black.svg" alt="" />
      <h3>Osaango</h3>
      <span>Community partner and method contributor.</span>
    </a>
  );
}
...
function AnnouncementToastDemo() {
  return (
    <aside className="ds-announcement ds-announcement-demo" role="status" aria-live="polite">
      <p>
        <span>Version 2.0 is live with faster loading times! See what's new </span>
        <a href="#governance">&rarr;</a>
      </p>
      <button type="button" aria-label="Dismiss announcement">&times;</button>
    </aside>
  );
}
  ...
  return (
    <main className="site-shell ds-shell">
      ...
      <section className="ds-section" id="foundations">
        ...
        <div className="ds-grid ds-grid--two">
          <article className="ds-panel">
            <img src="/design/glyphs/apiops-logo.svg" alt="apiops" width="128" height="128"  />
            <h3>APIOps</h3>
            <p>
          ...
          <article className="ds-panel">
            <img src="/design/glyphs/apiops-cycles-logo.svg" alt="apiops cycles" width="64" height="64" />
            <h3>APIOps Cycles</h3>
            <p>
        ...
        <div className="ds-grid ds-grid--three">
            ...
            <article className="ds-panel">
              ...
              >
                <SvgSpritePreview
                  source="/design/icons/apiops-metro-icons.svg"
            ...
            <article className="ds-panel">
              ...
              >
                <SvgSpritePreview
                  ...
                  symbolId="glyph-hub"
                  label="Hub"
                  accent="var(--apiops-accent-strategy)"
                />
              </AnatomyPreview>
            </article>
            <article className="ds-panel">
              ...
              >
                <SvgSpritePreview
                  ...
                  label="Region"
                  accent="var(--apiops-accent-context)"
                />
              </AnatomyPreview>
            </article>
            <article className="ds-panel">
             ...
             <AnatomyPreview
              ...
              >
                <SvgSpritePreview
                  source="/design/humans/apiops-stick-figures-poses.svg"
            ...
            <article className="ds-panel">
              ...
              >
                <SvgSpritePreview
                  source="/design/icons/apiops-iconset.svg"
                  symbolId="icon-risk"
                  label="Risk"
      ...
      <section className="ds-section" id="principles">
          ...
          <div className="ds-grid ds-grid--two">
          <article className="ds-panel">
              <svg width="224" aria-hidden="true" className="ds-asset-size-symbol" viewBox="20 30 225 410"><use href="/design/humans/apiops-stick-figures-stories.svg#g59"></use></svg>
